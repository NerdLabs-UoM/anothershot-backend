...
export class ClientService {
    ...
    async getClientDetails(id: string) {
        ...
        try {
            ...
            throw new HttpException('Failed to fetch client details', HttpStatus.NOT_FOUND);
        }
    }
    ...
    async deleteBooking(dto: DeleteBookingDto) {
        ...
        try {
            ...
            this.logger.error(`Failed to delete booking with ID: ${dto.bookingId} for client`, error.stack);
            throw new HttpException('Failed to delete booking', HttpStatus.BAD_REQUEST);
        }
    }
}
