  ...
  private readonly logger = new Logger(PackagesController.name);
   ...
   async updatePackageDetails(@Body() dto: updatePackageDto) {
     try {
       ...
       const updatedPackage = await this.packagesService.updatePackageDetails(dto);
   ...
   async getPackageDetails(@Param('photographerId') photographerId: string) {
     try {
       ...
       const packages = await this.packagesService.getPackageDetails(photographerId);
   ...
   async getPackageById(@Param('packageId') packageId: string) {
     try {
       ...
       const packageDetails = await this.packagesService.getPackageById(packageId);
       if (!packageDetails) {
   ...
   async deletePackage(@Body() dto: deletePackageDto) {
     try {
       ...
       const deletedPackage = await this.packagesService.deletePackageDetails(dto);
