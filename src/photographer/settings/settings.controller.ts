...
export class SettingsController {
  ...
  async getBankDetails(@Param('id') id: string) {
    ...
    try {
      ...
      this.logger.error(
        `Failed to fetch bank details for ID: ${id}`,
        error.stack
      );
  ...
  async updateBankDetails(
    ...
    this.logger.log(
      `Received request to update bank details for photographer with ID: ${id} and data: ${JSON.stringify(
        dto
      )}`
    );
    try {
      const updatedDetails = await this.settingsService.updateBankDetails(
        id,
        dto
      );
      this.logger.log(
        `Successfully updated bank details for photographer with ID: ${id}`
      );
      return updatedDetails;
    } catch (error) {
      this.logger.error(
        `Failed to update bank details for photographer with ID: ${id}`,
        error.stack
      );
      throw new HttpException(
  ...
  async getCategoryById(@Param('id') id: string) {
    ...
    try {
      ...
      this.logger.error(
        `Failed to fetch category details for ID: ${id}`,
        error.stack
      );
      throw new HttpException(
  ...
  async updateCategory(
    ...
    this.logger.log(
      `Received request to update category for photographer with ID: ${id} and data: ${JSON.stringify(
        data
      )}`
    );
    try {
      const updatedCategory = await this.settingsService.updateCategory(
        id,
        data
      );
      this.logger.log(
        `Successfully updated category for photographer with ID: ${id}`
      );
      return updatedCategory;
    } catch (error) {
      this.logger.error(
        `Failed to update category for photographer with ID: ${id}`,
        error.stack
      );
      throw new HttpException(
  ...
  async getPayments(@Param('id') id: string, @Query('page') page: number) {
    this.logger.log(
      `Received request to fetch payments for photographer with ID: ${id}`
    );
    try {
  ...
  async getEarnings(@Param('id') id: string) {
    this.logger.log(
      `Received request to fetch earnings for photographer with ID: ${id}`
    );
    try {
      const earnings = await this.settingsService.getEarnings(id);
      this.logger.log(
        `Successfully fetched earnings for photographer with ID: ${id}`
      );
      return earnings;
    } catch (error) {
      this.logger.error(
        `Failed to fetch earnings for photographer with ID: ${id}`,
        error.stack
      );
      throw new HttpException(
